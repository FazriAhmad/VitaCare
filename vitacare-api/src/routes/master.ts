...
masterRouter.post('/cabang', wajibIzin('kelola_cabang'), async (req, res) => {
  const c = req.body
...
masterRouter.delete('/cabang/:id', wajibIzin('kelola_cabang'), async (req, res) => {
...
masterRouter.post('/poli', wajibIzin('kelola_poli'), async (req, res) => {
  const p = req.body
...
masterRouter.delete('/poli/:id', wajibIzin('kelola_poli'), async (req, res) => {
...
masterRouter.post('/dokter', wajibIzin('kelola_dokter'), async (req, res) => {
...
masterRouter.delete('/dokter/:id', wajibIzin('kelola_dokter'), async (req, res) => {
...
masterRouter.post('/jadwal', wajibIzin('kelola_jadwal'), async (req, res) => {
  const { id, ...data } = req.body
...
masterRouter.delete('/jadwal/:id', wajibIzin('kelola_jadwal'), async (req, res) => {
